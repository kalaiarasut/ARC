...
CREATE TABLE IF NOT EXISTS public.official_advisories (
  ...
  source_language TEXT NOT NULL DEFAULT 'en' CHECK (source_language IN ('en', 'ta', 'hi', 'te', 'ml')),
...
CREATE TABLE IF NOT EXISTS public.official_advisory_translations (
  ...
  language_code TEXT NOT NULL CHECK (language_code IN ('en', 'ta', 'hi', 'te', 'ml')),
  title TEXT NOT NULL,
  body TEXT NOT NULL,
  region TEXT,
...
CREATE TABLE IF NOT EXISTS public.push_tokens (
  ...
  language_code TEXT NOT NULL DEFAULT 'en' CHECK (language_code IN ('en', 'ta', 'hi', 'te', 'ml')),
  last_seen_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
